...
constexpr double attitude_y_active = 30; //!< Maximum Y attitude for controller to remain active, in degrees.
constexpr double attitude_y_gain_proportional = -5700; //!< Y attitude PID controller proportional gain.
constexpr double attitude_y_gain_differential = -30; //!< Y attitude PID controller differential gain.
...
constexpr double attitude_z_gain_open_loop = 0;    //!< Z attitude open-loop controller gain.
constexpr double position_x_gain_proportional = 0; //!< X position PID controller proportional gain.
constexpr double position_x_gain_differential = 0; //!< X position PID controller differential gain.
